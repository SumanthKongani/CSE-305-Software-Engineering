...
<title>Electric Car Rental Portal</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>We have several vehicles for you to choose. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>Electric Vehicle For You</span></h2>
      <p> Our visionary approach to revolutionising car rental processes is based on our move towards electricity powered vehicles. You can now rent an electric vehicle and go on your trip while contributing to the reducing net carbon emissions around the world and taking a responsible step towards a cleaner, greener future.</p>
    </div>
    <div class="row"> 
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-car" aria-hidden="true"></i>70+</h2>
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>350+</h2>
